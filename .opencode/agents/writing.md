...
- Write in Vietnamese, but only use English for specific English in Software Engineering that should not be used in Vietnamese causing confusion
- Writing clear and concise reports
- Each reference should be declared in [ref.bib](./src/ref.bib) and cited properly in the report
