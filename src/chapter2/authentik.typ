...
Authentik có giao diện quản lý thân thiện, hỗ trợ multi-tenancy và cung cấp các
tính năng bảo mật nâng cao cho việc quản lý danh tính người dùng trong các tổ
chức.
...
- Self-Hosted, có thể triển khai trên hạ tầng riêng, tránh phụ thuộc vào dịch vụ
  external
- Multi-Tenancy, hỗ trợ nhiều tenant trong một instance, lý tưởng cho SaaS
  applications
