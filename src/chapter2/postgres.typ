...
- Extensibility cao, cho phép mở rộng chức năng thông qua extensions (PostGIS, pgcrypto, uuid-ossp)
...
- Learning Curve cao, nhiều features nâng cao cần thời gian để master như partitioning, custom types
