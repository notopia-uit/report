...
RustFS là một hệ thống lưu trữ object storage được viết hoàn toàn bằng Rust, tương thích với API của Amazon S3. RustFS được phát triển như một giải pháp thay thế hiệu suất cao hơn cho MinIO, đặc biệt là trong các trường hợp cần throughput lớn và latency thấp.
...
- Memory Safety, Rust đảm bảo memory safety, giảm thiểu các bug liên quan đến bộ nhớ
...
- Active Development, dự án được duy trì tích cực với các feature mới thường xuyên
...
- Feature Parity, một số tính năng nâng cao của S3 có thể chưa được hỗ trợ đầy đủ
