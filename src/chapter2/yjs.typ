...
TypeScript @yjs, thiết kế để hỗ trợ real-time collaboration trên nhiều nền tảng.
...
- CRDT-Based Merging, xung đột được giải quyết tự động mà không cần quản lý
  conflict manual
- Offline Support, người dùng có thể tiếp tục làm việc offline và dữ liệu sẽ
...
- Performance, được tối ưu cho hiệu suất cao, hỗ trợ xử lý các thay đổi lớn một
  cách hiệu quả
- Ecosystem, hỗ trợ nhiều binding và integration với các tool khác như Tiptap,
  Monaco Editor, CodeMirror
- Awareness, cung cấp khái niệm "awareness" để hiển thị con trỏ và lựa chọn của
  người dùng khác
